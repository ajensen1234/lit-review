...
\title{Methods for Autonomous Measurement of 3D Joint Kinematics from 2D Fluoroscopic Images}%  Put your title here.

\degreeType{Doctor of Philosophy}%   Official name of your degree; e.g. "Doctorate of Philosophy."
...
%\setReferenceFile{./src/myBib.bib}{IEEEtran}%         References. First argument is your bibtex source file
\setReferenceFile{./src/myBib.bib}%         References. First argument is your bibtex source file
%\setReferenceFile{./src/myBib.bib}{abbrvbib}
...
\include{src/1-Intro/ch1-lit_review.tex}
\include{src/2-aims/2-aims.tex}
\include{src/JTML/chX-jtml}
\include{src/SymTrap/sym_trap_paper}
\include{src/aim3/aim3}
\include{src/aim4-shape-sensitivity/aim4}
