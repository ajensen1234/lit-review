...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org532cd77}]{Our Proposition}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc1450c8}]{Constraints}
\begin{columns}
...
\end{frame}
\section{Background}
\label{sec:orge0b2e76}
\begin{frame}[label={sec:org537f01b}]{Background - Projective Geometry}
\begin{center}
\includegraphics[width=0.8\textwidth]{/home/ajensen123@ad.ufl.edu/repo/lit-review/figures/raster/perspective-projection.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org204419c}]{Background - Model-Image Registration}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3a79b30}]{Background - Model-Image Registration}
\begin{columns}
\begin{column}{0.5\columnwidth}
If we know the projective parameters of the fluoroscopy machine, can we tinker with \(T^{cam}_{implant}\) so that our virtual projection matches the fluoroscopic image?
\end{column}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8f02208}]{Historical Overview}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7f3041d}]{Pre-Computed Projections}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge169c02}]{Limitations of Pre-Computed Projections}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb0deec5}]{Motion Capture (MoCap)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6757ca6}]{Limitations of Motion Capture}
\begin{columns}
\begin{column}{0.5\columnwidth}
Skin Mounted
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6b1f664}]{Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgcf08bda}]{Limitations of Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0166fa8}]{Iterative Projections}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2ee3ec5}]{Limitations of (historic) Iterative Projection Methods}
\begin{columns}
\begin{column}{0.54\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgadaa7c1}]{Roentgen Stereophotogrammetry (RSA)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org578a08e}]{Limitations of RSA}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{frame}
\section{Aims}
\label{sec:org014845a}
\begin{frame}[label={sec:orgbce4f40}]{Aims}
...
\label{sec:org0c80547}
\begin{frame}[label={sec:org3c1eb1a}]{Goal}
Demonstrate the feasibility of a fully autonomous, model-image registration pipeline.
\end{frame}
\begin{frame}[label={sec:org392f17a}]{Method}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4f3a2d0}]{Autonomous Implant Detection Using Convolutional Neural Networks}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item 2 CNNs
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge084820}]{Neural Network Data}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge7e9659}]{Neural Network Robustness}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc5a1cfc}]{Normalized Fourier Descriptor Shape Libraries}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8723276}]{Pose Refinement Using Global Optimization}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org18456b1}]{Contour-based Objective Function}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd2ddfd6}]{Improving Robustness}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgadb5a3b}]{Optimization Routine}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org76d621f}]{Lipschitzian Optimization}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3927ebb}]{Lipschitzian Optimization without the Lipschitz Constant}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org7accfcf}]{Trisecting Region}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org389eeb5}]{Another Iteration}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
  \begin{bmatrix}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org97ba071}]{Determining Potentially Optimal Regions}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org6f9196a}]{DiRECT for Joint Track Machine Learning}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org00f2598}]{Testing Performance}
Now that we have our refined poses, how well does out system perform?
\begin{center}
\includegraphics[width=\textwidth]{/home/ajensen123@ad.ufl.edu/repo/lit-review/figures/raster/jtml-pipeline.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgda6dd74}]{Validation}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb1c9ed7}]{Awards}
...
\label{sec:org689480a}
\begin{frame}[label={sec:org5861868}]{Goal}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgfba0ea6}]{Translation}
\begin{itemize}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org6b101b4}]{Symmetry Traps}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgcefc03f}]{Solving the Symmetric Pose}
\begin{columns}
\begin{column}{0.55\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgdff47a0}]{Methods - Training Set}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3b621e8}]{Methods - Machine Learning}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga91f020},fragile]{Methods - Fixing ``Symmetry Traps''}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org5cbbded}]{Results - ML Classification}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajensen123@ad.ufl.edu/figures/raster/sym-trap-ML-table.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org7e4648c}]{Results - Fixing ``Symmetry Traps''}
\begin{itemize}
\item Accuracy: 91.9\%
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org900e511}]{Results - Stratified \(\psi\) Correction Performance}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajensen123@ad.ufl.edu/figures/raster/stratified-psi-ML-table.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orga266bdd}]{Discussion}
\begin{itemize}
...
\label{sec:orgf627f86}
\begin{frame}[label={sec:org6208cbc}]{A Kinematics Translator?}
\begin{itemize}
\item We all understand the idea of translating a sentence (say, English) to a different language (say, French).
\begin{itemize}
\item The ``meaning'' (whatever that actually means\footnote{For instance, a Platonist might argue these have to do with the forms, an Aristotelian would say it must invoke the instantiation of the four causes.}) of the sentence stays the same, but the specific letters/phonemes used to produce that meaning are different.
\end{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org20403c9}]{A High-Level Mathematical Framework}
\begin{figure}[htbp]
\centering
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org3cd5f53}]{There is not enough standardized kinematics data}
\begin{enumerate}
\item Different research groups give the same name to different movements.
\begin{itemize}
\item Squat, lunge, and kneel have no formal definiton, and some groups' ``squat'' has the same qualities as other groups' ``lunge''.
\end{itemize}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org2e275f6}]{A path forward}
With a fully-autonomous system for measuring kinematics, interested research groups have asked us which movements to measure. Should this move toward widespread clinical adoption, standards for ``Kinematics Evaluations'' can be established to standardize data.
\end{frame}
\subsection{Aim 4 - This will definitely work on shoulders, right?}
\label{sec:orgdcb1613}

\begin{frame}[label={sec:orgc193c0a}]{Spoiler Alert}
\begin{columns}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org51d9eb3}]{Improving Error Gradient}
\begin{itemize}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org6713349}]{Modified Mean Surface Distance}
\begin{itemize}
...
{\tiny It didn't work.}
\end{frame}
\begin{frame}[label={sec:org7fa5c49}]{Modified Asymmetric Keypoint Distance}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgbb5188d}]{Modified Asymmetric Keypoint Distance}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org70a0d94}]{2-Dimensional Shape}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6a4f383}]{Invariant Angular Radial Transform Descriptor}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org92b3a78}]{IARTD Feature Vector}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org94ceb80}]{Normalizing IARTD Feature Vector}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org37f8921}]{Methods - Shape Difference}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgfca7b21}]{Methods - Shape Sensitivity}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org7943ef0}]{Results - Humeral Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org5d0f663}]{Results - Glenosphere Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org9b47f6d}]{Results - Femoral Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgff916c9}]{Results - Tibial Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org3884e1e}]{Key Takeaways}
\begin{itemize}
...
\end{frame}
\section{Conclusion}
\label{sec:org6e053fa}
\begin{frame}[label={sec:org01c42c5}]{Conclusions}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:orgd45c12c},fragile, allowframebreaks, label=]{Presentations}
\begin{refsection}
...
\end{refsection}
\end{frame}
\begin{frame}[label={sec:org8ba3566},fragile, allowframebreaks, label=]{Publications}
\begin{refsection}
	\newrefcontext[sorting=ynt]
	\input{nocites-pubs}
...
\end{refsection}
\end{frame}
\begin{frame}[label={sec:org28993e8}]{Timeline}
\begin{center}
\begin{tabular}{ll}
Date(s) & Event\\
\hline
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4166c28}]{Thank you!}
Thanks for listening!!

Any Questions?
\end{frame}
\section{References}
\label{sec:orge0ec713}
\begin{frame}[label={sec:org80104b3},fragile, allowframebreaks,  label=]{References}
\printbibliography
\end{frame}
\end{document}
