...
\begin{frame}[label={sec:org6329efb}]{A PhD\ldots{}offense?}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajj/figures/raster/thesis_defense_2x.png}
\end{center}
\end{column}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajj/figures/raster/phd_offense.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgce41df5}]{A PhD\ldots{}offense?}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajj/figures/raster/banks_dissertation.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgacdb723}]{A PhD\ldots{}offense?}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajj/figures/raster/nichols_dissertation.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb9d90cb}]{A PhD\ldots{}offense?}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajj/figures/raster/allen_dissertation.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org988004a}]{A PhD\ldots{}offense?}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajj/figures/raster/costello_dissertation.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org81d50dd}]{A PhD\ldots{}offense?}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajj/figures/raster/silva_dissertation.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org9e187fd}]{Acknowledgments}
I would like to thank the McJunkin Family Charitable Foundation for their generous grant that supports this work.
\end{frame}
\begin{frame}[label={sec:org36c96bb}]{The Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajj/repo/lit-review/figures/raster/Physical_Examination_of_the_knee.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf3d30fb}]{Our Proposition}
\begin{columns}
\begin{column}{0.5\columnwidth}
Orthopaedic surgeons and clinicians would readily adopt a \alert{\alert{practical}} and \alert{\alert{inexpensive}} technology that allows them to \alert{\alert{measure}} a patient's joint kinematics during \alert{\alert{activities of daily living}}.
\end{column}
\begin{column}{0.55\columnwidth}
\begin{center}
\includegraphics[width=2in]{/home/ajj/repo/lit-review/figures/raster/dynamic-knee-prescription.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2875d24}]{Constraints}
\begin{columns}
...
\begin{column}{0.55\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajj/repo/lit-review/figures/raster/c-arm-fluoro-machine.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
\section{Background}
\label{sec:org8001ce4}
\begin{frame}[label={sec:org6e5b403}]{Background - Projective Geometry}
\begin{center}
\includegraphics[width=0.8\textwidth]{/home/ajj/repo/lit-review/figures/raster/perspective-projection.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org1c1f561}]{Background - Model-Image Registration}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=2.5in]{/home/ajj/repo/lit-review/figures/raster/registered-tka.png}
\caption{From \autocite{mahfouzRobustMethodRegistration2003}}
\end{figure}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga1363a4}]{Background - Model-Image Registration}
\begin{columns}
\begin{column}{0.5\columnwidth}
If we know the projective parameters of the fluoroscopy machine, can we tinker with \(T^{cam}_{implant}\) so that our virtual projection matches the fluoroscopic image?
\end{column}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=2.5in]{/home/ajj/repo/lit-review/figures/raster/mahfouz-perspective-projection.png}
\caption{From \autocite{mahfouzRobustMethodRegistration2003}}
\end{figure}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga1a7db4}]{Historical Overview}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org3d2c8a9}]{Pre-Computed Projections}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.5in]{/home/ajj/repo/lit-review/figures/raster/lavallee-distance-maps.png}
\caption{From \autocite{lavalleeRecoveringPositionOrientation1995}}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.5in]{/home/ajj/repo/lit-review/figures/raster/banks-nfd-library.png}
\caption{From \autocite{banksAccurateMeasurementThreedimensional1996}}
\end{figure}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5fa2dcd}]{Limitations of Pre-Computed Projections}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc04616d}]{Motion Capture (MoCap)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=2.5in]{/home/ajj/repo/lit-review/figures/raster/gao-skin-mocap.png}
\caption{From \autocite{gaoInvestigationSoftTissue2008}}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=2in]{/home/ajj/repo/lit-review/figures/raster/lafortune-bone-mocap.png}
\caption{From \autocite{lafortuneThreedimensionalKinematicsHuman1992}}
\end{figure}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgcdfdb1a}]{Limitations of Motion Capture}
\begin{columns}
\begin{column}{0.5\columnwidth}
Skin Mounted
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org745b776}]{Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.75in]{/home/ajj/repo/lit-review/figures/raster/ivester-stereo-fluoromachine.png}
\caption{Both from \autocite{ivesterReconfigurableHighSpeedStereoRadiography2015}}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.75in]{/home/ajj/repo/lit-review/figures/raster/ivester-stereo-projection.png}
\end{figure}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0d96f93}]{Limitations of Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org05d2208}]{Iterative Projections}
\begin{columns}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=2in]{/home/ajj/repo/lit-review/figures/raster/mahfouz-perspective-projection.png}
\caption{From \autocite{mahfouzRobustMethodRegistration2003}}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=2in]{/home/ajj/repo/lit-review/figures/raster/flood-dilated-contour.png}
\caption{From \autocite{floodAutomatedRegistration3D2018}}
\end{figure}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgeee0d5d}]{Limitations of (historic) Iterative Projection Methods}
\begin{columns}
\begin{column}{0.54\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org026824d}]{Roentgen Stereophotogrammetry (RSA)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=3in]{/home/ajj/repo/lit-review/figures/raster/vrooman-mbrsa.png}
\caption{From \autocite{vroomanFastAccurateAutomated1998}}
\end{figure}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgad64553}]{Limitations of RSA}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{frame}
\section{Aims}
\label{sec:org2840e06}
\begin{frame}[label={sec:orge5dc813}]{Aims}
...
\label{sec:org808fca4}
\begin{frame}[label={sec:org9a819f1}]{Goal}
Demonstrate the feasibility of a fully autonomous, model-image registration pipeline.
\end{frame}
\begin{frame}[label={sec:org48a8ba8}]{Method}
\begin{itemize}
...
\end{itemize}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajj/repo/lit-review/figures/raster/jtml-pipeline.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org266088a}]{Autonomous Implant Detection Using Convolutional Neural Networks}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item 2 CNNs
...
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=\columnwidth]{/home/ajj/repo/lit-review/figures/raster/jtml-segmentation.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org571ca17}]{Neural Network Data}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[height=3in]{/home/ajj/repo/lit-review/figures/raster/jtml-data.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgaf7ce46}]{Neural Network Robustness}
\begin{itemize}
\item Additional augmentations introduced during training \autocite{buslaevAlbumentationsFastFlexible2020}.
\end{itemize}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajj/repo/lit-review/figures/raster/augmentations.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org46ce22d}]{Normalized Fourier Descriptor Shape Libraries}
\begin{columns}
...
\begin{center}
\includegraphics[width=2in]{/home/ajj/repo/lit-review/figures/raster/banks-nfd-library.png}
\end{center}
\begin{center}
\includegraphics[width=3.25in]{/home/ajj/repo/lit-review/figures/raster/jtml-nfd.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge37eeb3}]{Pose Refinement Using Global Optimization}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd3ffbf5}]{Contour-based Objective Function}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajj/repo/lit-review/figures/raster/registered-tka.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org499b173}]{Improving Robustness}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajj/repo/lit-review/figures/raster/flood-dilated-contour.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org47a7cad}]{Optimization Routine}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org08eeddc}]{Lipschitzian Optimization}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=2in]{/home/ajj/repo/lit-review/figures/raster/shubert-step1.png}
\end{center}
\begin{center}
\includegraphics[width=2in]{/home/ajj/repo/lit-review/figures/raster/shubert-step2.png}
\end{center}
\begin{center}
\includegraphics[width=2in]{/home/ajj/repo/lit-review/figures/raster/shubert-step3.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org36694b6}]{Lipschitzian Optimization without the Lipschitz Constant}
\begin{center}
\includegraphics[width=2.5in]{/home/ajj/repo/lit-review/figures/raster/jones-direct-title.png}
\end{center}
\begin{itemize}
...
\end{itemize}
\begin{center}
\includegraphics[width=2.5in]{/home/ajj/repo/lit-review/figures/raster/direct-1D.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb3b1f7a}]{Trisecting Region}
\begin{columns}
...
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajj/repo/lit-review/figures/raster/direct-1D-stage1.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge0f9700}]{Another Iteration}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
  \begin{bmatrix}
...
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajj/repo/lit-review/figures/raster/direct-1D-stage2.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org32cd4d8}]{Determining Potentially Optimal Regions}
\begin{itemize}
...
\begin{center}
\includegraphics[width=0.6\textwidth]{/home/ajj/repo/lit-review/figures/raster/direct-convex-hull.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgaf2e085}]{DiRECT for Joint Track Machine Learning}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org6ede805}]{Testing Performance}
Now that we have our refined poses, how well does out system perform?
\begin{center}
\includegraphics[width=\textwidth]{/home/ajj/repo/lit-review/figures/raster/jtml-pipeline.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org6ba02af}]{Validation}
\begin{itemize}
...
\begin{center}
\includegraphics[width=0.7\textwidth]{/home/ajj/repo/lit-review/figures/raster/broberg-bland-altmann.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org88706e8}]{Awards}
...
\begin{center}
\includegraphics[width=0.7\textwidth]{/home/ajj/repo/lit-review/figures/raster/ista-hap-paul-talk.png}
\end{center}
\end{frame}
\subsection{Aim 2 - Correcting Symmetric Implant Ambiguity}
\label{sec:orga6c083e}
\begin{frame}[label={sec:orgf66ca26}]{Goal}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8618458}]{Symmetry Traps}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{column}{0.6\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajj/figures/raster/sym-trap-quadrants-no-captions.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgdc41961}]{Solving the Symmetric Pose}
\begin{columns}
\begin{column}{0.55\columnwidth}
...
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/ajj/figures/raster/symmetry_flipper.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org9172027}]{Methods - Training Set}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{/home/ajj/figures/raster/symmetry-trap-dataset.png}
\caption{The training data plotted with each axis representing an anatomical rotation (origin not to scale).}
\end{figure}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org508aa28}]{Methods - Machine Learning}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgdf88a4e},fragile]{Methods - Fixing ``Symmetry Traps''}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org3039934}]{Results - ML Classification}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajj/figures/raster/sym-trap-ML-table.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org835da0c}]{Results - Fixing ``Symmetry Traps''}
\begin{itemize}
\item Accuracy: 91.9\%
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org00b27ac}]{Results - Stratified \(\psi\) Correction Performance}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajj/figures/raster/stratified-psi-ML-table.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgec91f92}]{Discussion}
\begin{itemize}
...
\label{sec:org9c00ba6}
\begin{frame}[label={sec:orgd49ab27}]{A Kinematics Translator?}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1a4d535}]{A High-Level Mathematical Framework}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.65\textwidth]{/home/ajj/figures/raster/ye_geometry_of_generative_models.png}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org894c1b2}]{Not enough standardized kinematics data exists}
\begin{enumerate}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org5472252}]{A path forward}
...
\label{sec:org11960bd}

\begin{frame}[label={sec:orgce3ecc2}]{Spoiler Alert}
\begin{columns}
...
\begin{column}{0.7\columnwidth}
\begin{center}
\includegraphics[width=1.5in]{/home/ajj/figures/raster/BAD_IE_HUM.png}
\end{center}

\begin{center}
\includegraphics[width=1.5in]{/home/ajj/figures/raster/BAD_PROXDIST_HUM.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4e1312d}]{Goal}
Establish a protocol for exploring the relative sensitivity of input orientation to projected shape
\end{frame}
\begin{frame}[label={sec:orgc30dce0}]{JTML on Shoulders}
\begin{table}[h!]
\small
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org8c09773}]{Improving Error Gradient}
\begin{itemize}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org26d2380}]{Modified Mean Surface Distance}
\begin{itemize}
...
{\tiny It didn't work.}
\end{frame}
\begin{frame}[label={sec:org2853427}]{Modified Asymmetric Keypoint Distance}
\begin{itemize}
...
\begin{center}
\includegraphics[width=0.85\textwidth]{/home/ajj/figures/raster/TSA_curvature.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org11626f4}]{Modified Asymmetric Keypoint Distance}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orgdd7a7c5}]{2-Dimensional Shape}
\begin{itemize}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org5379664}]{Normalizing IARTD Feature Vector}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgde7250c}]{Methods - Shape Difference}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/ajj/figures/raster/rTSA_humeral_rotation_axes.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org61c407c}]{Methods - Shape Sensitivity}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org56e3a1d}]{Results - Humeral Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgcd31883}]{Results - Glenosphere Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgec4ceff}]{Results - Femoral Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgc03c48e}]{Results - Tibial Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org6fdaaa0}]{Key Takeaways}
\begin{itemize}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgff4d478}]{Next Steps}
\begin{itemize}
...
\end{frame}
\section{Conclusion}
\label{sec:orga1726e2}
\begin{frame}[label={sec:org741661d}]{Conclusions}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org0a0e645},fragile, allowframebreaks, label=]{Presentations}
\begin{refsection}
...
\end{refsection}
\end{frame}
\begin{frame}[label={sec:org6173427},fragile, allowframebreaks, label=]{Publications}
\begin{refsection}
	\newrefcontext[sorting=ynt]
	\input{nocites-pubs}
...
\end{refsection}
\end{frame}
\begin{frame}[label={sec:orga1df076}]{Timeline}
\begin{center}
\begin{tabular}{ll}
Date(s) & Event\\
\hline
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org142754f}]{A Special Thanks}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item Dr. Scott Banks
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7019d11}]{Thank you!}
Thanks for listening!!

Any Questions?

\begin{center}
\includegraphics[width=0.8\linewidth]{/home/ajj/figures/raster/first_banks_email.png}
\end{center}
\end{frame}
\section{References}
\label{sec:org2b097ea}
\begin{frame}[label={sec:org65c7a97},fragile, allowframebreaks,  label=]{References}
