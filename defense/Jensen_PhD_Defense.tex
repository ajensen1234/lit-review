...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org86170fc}]{Our Proposition}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3b4ed12}]{Constraints}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2c81c12}]{Background - Projective Geometry}
\begin{center}
\includegraphics[width=0.8\textwidth]{/home/ajensen123@ad.ufl.edu/repo/lit-review/figures/raster/perspective-projection.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgea0b133}]{Background - Model-Image Registration}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org561975b}]{Background - Model-Image Registration}
\begin{columns}
\begin{column}{0.5\columnwidth}
If we know the projective parameters of the fluoroscopy machine, can we tinker with \(T^{cam}_{implant}\) so that our virtual projection matches the fluoroscopic image?
\end{column}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5afe9d4}]{Historical Overview}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org62bbd47}]{Pre-Computed Projections}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgebda42c}]{Limitations of Pre-Computed Projections}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgede6730}]{Motion Capture (MoCap)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org21295ad}]{Limitations of Motion Capture}
\begin{columns}
\begin{column}{0.5\columnwidth}
Skin Mounted
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org1d59a0a}]{Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org15c1b44}]{Limitations of Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0501026}]{Iterative Projections}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org10a83aa}]{Limitations of (historic) Iterative Projection Methods}
\begin{columns}
\begin{column}{0.54\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org05235f6}]{Roentgen Stereophotogrammetry (RSA)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2917561}]{Limitations of RSA}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{frame}
\section{Aims}
\label{sec:orgcfb868e}
\begin{frame}[label={sec:org890ff06}]{Aims}
...
\label{sec:orgf6561bc}
\begin{frame}[label={sec:orgd33ffa4}]{Goal}
Demonstrate the feasibility of a fully autonomous, model-image registration pipeline.
\end{frame}
\begin{frame}[label={sec:org3e10317}]{Method}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org821765a}]{Autonomous Implant Detection Using Convolutional Neural Networks}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item 2 CNNs
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org525eaf1}]{Neural Network Data}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd9728f0}]{Neural Network Robustness}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org75ac425}]{Normalized Fourier Descriptor Shape Libraries}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org770be4c}]{Pose Refinement Using Global Optimization}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2f20f7f}]{Contour-based Objective Function}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgccaa48f}]{Improving Robustness}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6fcfdc1}]{Optimization Routine}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org08ff2f3}]{Lipschitzian Optimization}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org122a852}]{Lipschitzian Optimization without the Lipschitz Constant}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc652f7d}]{Trisecting Region}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7efd96b}]{Another Iteration}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
  \begin{bmatrix}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga21b35e}]{Determining Potentially Optimal Regions}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4329879}]{DiRECT for Joint Track Machine Learning}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb063b5d}]{Testing Performance}
Now that we have our refined poses, how well does out system perform?
\begin{center}
\includegraphics[width=\textwidth]{/home/ajensen123@ad.ufl.edu/repo/lit-review/figures/raster/jtml-pipeline.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org6e559ac}]{Validation}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org43e21a4}]{Awards}
...
\label{sec:org6f45fb7}
\begin{frame}[label={sec:org7052cc9}]{Goal}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgac91e68}]{Translation}
\begin{itemize}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org10ebd7e}]{Symmetry Traps}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgab15c48}]{Solving the Symmetric Pose}
\begin{columns}
\begin{column}{0.55\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4a8965e}]{Methods - Training Set}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf57e9e4}]{Methods - Machine Learning}
Using \texttt{scikit-learn}, we implemented the following classification algorithms:

\begin{itemize}
\item K-Nearest-Neighbors, Support Vector Machines, Stacked Generalization, Voting Classifier
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd0b64d1},fragile]{Methods - Fixing ``Symmetry Traps''}
 For an input image sequence, we perform the following:
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:orgd837b4c}]{Results - ML Classification}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajensen123@ad.ufl.edu/figures/raster/sym-trap-ML-table.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc65f4aa}]{Results - Fixing ``Symmetry Traps''}
\begin{itemize}
\item Accuracy: 91.9\%
...
We also measured the distribution of \(\psi\) for correct and incorrect frames.
\begin{itemize}
\item Average \(\psi_{correct}=16.6^{\circ}\).
\item Average \(\psi_{incorrect} = 7.12^{\circ}\).
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org2576e0a}]{Results - Stratified \(\psi\) Correction Performance}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajensen123@ad.ufl.edu/figures/raster/stratified-psi-ML-table.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org9aeb628}]{Discussion}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org59ea9cb},fragile, allowframebreaks, label=]{Presentations}
\begin{refsection}
  \input{nocites-pres}
  \printbibliography[title=Presentations]
\end{refsection}
\end{frame}
\begin{frame}[label={sec:org530be1d},fragile, allowframebreaks, label=]{Publications}
\begin{refsection}
  \input{nocites-pubs}
  \printbibliography[title=Publications]
\end{refsection}
\end{frame}
\begin{frame}[label={sec:orgf976cc2}]{Timeline}
\begin{center}
\begin{tabular}{ll}
Date(s) & Event\\
\hline
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgdeefea1},standout]{Thank you!}
Thanks for listening!!
\end{frame}
\section{References}
\label{sec:org277416b}
\begin{frame}[label={sec:org9fde354},fragile, allowframebreaks, label=]{References}
