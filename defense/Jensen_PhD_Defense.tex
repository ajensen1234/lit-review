...
\usepackage[sorting=none,backend=biber, isbn=false, url=false]{biblatex}
...
\begin{frame}[label={sec:org77f72a6}]{A PhD\ldots{}offense?}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajensen123@ad.ufl.edu/figures/raster/thesis_defense_2x.png}
\end{center}
\end{column}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajensen123@ad.ufl.edu/figures/raster/phd_offense.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org9bfe8a8}]{A PhD\ldots{}offense?}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajensen123@ad.ufl.edu/figures/raster/banks_dissertation.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org4c4dfe1}]{A PhD\ldots{}offense?}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajensen123@ad.ufl.edu/figures/raster/nichols_dissertation.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org7dd91cd}]{A PhD\ldots{}offense?}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajensen123@ad.ufl.edu/figures/raster/allen_dissertation.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org2b00bae}]{A PhD\ldots{}offense?}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajensen123@ad.ufl.edu/figures/raster/costello_dissertation.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org1ce3723}]{A PhD\ldots{}offense?}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/ajensen123@ad.ufl.edu/figures/raster/silva_dissertation.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org07b5eff}]{Acknowledgments}
I would like to thank the McJunkin Family Charitable Foundation for their generous grant that supports this work.
\end{frame}
\begin{frame}[label={sec:orgd9c4712}]{The Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb126972}]{Our Proposition}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3a59c62}]{Constraints}
\begin{columns}
...
\end{frame}
\section{Background}
\label{sec:org5581728}
\begin{frame}[label={sec:orgdc32825}]{Background - Projective Geometry}
\begin{center}
\includegraphics[width=0.8\textwidth]{/home/ajensen123@ad.ufl.edu/repo/lit-review/figures/raster/perspective-projection.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgf7a807d}]{Background - Model-Image Registration}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgbdac73c}]{Background - Model-Image Registration}
\begin{columns}
\begin{column}{0.5\columnwidth}
If we know the projective parameters of the fluoroscopy machine, can we tinker with \(T^{cam}_{implant}\) so that our virtual projection matches the fluoroscopic image?
\end{column}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org464ad3c}]{Historical Overview}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org54eb546}]{Pre-Computed Projections}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.5in]{/home/ajensen123@ad.ufl.edu/repo/lit-review/figures/raster/lavallee-distance-maps.png}
\caption{From \autocite{lavalleeRecoveringPositionOrientation1995}}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.5in]{/home/ajensen123@ad.ufl.edu/repo/lit-review/figures/raster/banks-nfd-library.png}
\caption{From \autocite{banksAccurateMeasurementThreedimensional1996}}
\end{figure}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:orged62f62}]{Limitations of Pre-Computed Projections}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org301868f}]{Motion Capture (MoCap)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=2in]{/home/ajensen123@ad.ufl.edu/repo/lit-review/figures/raster/lafortune-bone-mocap.png}
\caption{From \autocite{lafortuneThreedimensionalKinematicsHuman1992}}
\end{figure}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6155b37}]{Limitations of Motion Capture}
\begin{columns}
\begin{column}{0.5\columnwidth}
Skin Mounted
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2e687c1}]{Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgca5e90a}]{Limitations of Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5e426a9}]{Iterative Projections}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7729467}]{Limitations of (historic) Iterative Projection Methods}
\begin{columns}
\begin{column}{0.54\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5e6fab2}]{Roentgen Stereophotogrammetry (RSA)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge4e8995}]{Limitations of RSA}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{frame}
\section{Aims}
\label{sec:org1ec46f5}
\begin{frame}[label={sec:org298ccd2}]{Aims}
...
\label{sec:org36138a8}
\begin{frame}[label={sec:orgb91ce25}]{Goal}
Demonstrate the feasibility of a fully autonomous, model-image registration pipeline.
\end{frame}
\begin{frame}[label={sec:orge745cdf}]{Method}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org08cc70f}]{Autonomous Implant Detection Using Convolutional Neural Networks}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item 2 CNNs
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgccea869}]{Neural Network Data}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8fe0042}]{Neural Network Robustness}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org5a4ca88}]{Normalized Fourier Descriptor Shape Libraries}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org62c2b3d}]{Pose Refinement Using Global Optimization}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge727f60}]{Contour-based Objective Function}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org508d5c8}]{Improving Robustness}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8d3f95c}]{Optimization Routine}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb8f4804}]{Lipschitzian Optimization}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org63992cd}]{Lipschitzian Optimization without the Lipschitz Constant}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4bab37a}]{Trisecting Region}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5b83838}]{Another Iteration}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
  \begin{bmatrix}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd2d169e}]{Determining Potentially Optimal Regions}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc1dfe15}]{DiRECT for Joint Track Machine Learning}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org44f3779}]{Testing Performance}
Now that we have our refined poses, how well does out system perform?
\begin{center}
\includegraphics[width=\textwidth]{/home/ajensen123@ad.ufl.edu/repo/lit-review/figures/raster/jtml-pipeline.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgaa3db90}]{Validation}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgf8c28fb}]{Awards}
...
\label{sec:org54787ba}
\begin{frame}[label={sec:orge12b42f}]{Goal}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org646f77d}]{Symmetry Traps}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb386634}]{Solving the Symmetric Pose}
\begin{columns}
\begin{column}{0.55\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org44510e2}]{Methods - Training Set}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8449efb}]{Methods - Machine Learning}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org74c21bb},fragile]{Methods - Fixing ``Symmetry Traps''}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org3ce2281}]{Results - ML Classification}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajensen123@ad.ufl.edu/figures/raster/sym-trap-ML-table.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org4ceb9a8}]{Results - Fixing ``Symmetry Traps''}
\begin{itemize}
\item Accuracy: 91.9\%
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0f3bcd2}]{Results - Stratified \(\psi\) Correction Performance}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajensen123@ad.ufl.edu/figures/raster/stratified-psi-ML-table.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgbd87a4b}]{Discussion}
\begin{itemize}
...
\label{sec:org5ad2b09}
\begin{frame}[label={sec:org2fb3fc0}]{A Kinematics Translator?}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org42d1a17}]{A High-Level Mathematical Framework}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.65\textwidth]{/home/ajensen123@ad.ufl.edu/figures/raster/ye_geometry_of_generative_models.png}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org446e132}]{Not enough standardized kinematics data exists}
\begin{enumerate}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org94c350b}]{A path forward}
...
\label{sec:org61db7cc}

\begin{frame}[label={sec:orgc3919d8}]{Spoiler Alert}
\begin{columns}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org2f0be6b}]{Improving Error Gradient}
\begin{itemize}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgea0da52}]{Modified Mean Surface Distance}
\begin{itemize}
...
{\tiny It didn't work.}
\end{frame}
\begin{frame}[label={sec:org10d1790}]{Modified Asymmetric Keypoint Distance}
\begin{itemize}
...
\begin{center}
\includegraphics[width=0.85\textwidth]{/home/ajensen123@ad.ufl.edu/figures/raster/TSA_curvature.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb10e9fd}]{Modified Asymmetric Keypoint Distance}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org9922edf}]{2-Dimensional Shape}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org5282169}]{Invariant Angular Radial Transform Descriptor}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org78bf814}]{IARTD Feature Vector}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org85927cc}]{Normalizing IARTD Feature Vector}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgef6e9a2}]{Methods - Shape Difference}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4dd9c7d}]{Methods - Shape Sensitivity}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org577f7b2}]{Results - Humeral Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org39f1128}]{Results - Glenosphere Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgd43bfca}]{Results - Femoral Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org6135a1d}]{Results - Tibial Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org61b01a4}]{Key Takeaways}
\begin{itemize}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org4253ece}]{Next Steps}
\begin{itemize}
...
\end{frame}
\section{Conclusion}
\label{sec:org0cc0c43}
\begin{frame}[label={sec:orgaa0bcbd}]{Conclusions}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org214b7dc},fragile, allowframebreaks, label=]{Presentations}
\begin{refsection}
...
\end{refsection}
\end{frame}
\begin{frame}[label={sec:org51f9eae},fragile, allowframebreaks, label=]{Publications}
\begin{refsection}
	\newrefcontext[sorting=ynt]
	\input{nocites-pubs}
...
\end{refsection}
\end{frame}
\begin{frame}[label={sec:org9f1c89a}]{Timeline}
\begin{center}
\begin{tabular}{ll}
Date(s) & Event\\
\hline
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org14ffc8f}]{A Special Thanks}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item Dr. Scott Banks
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org080c603}]{Thank you!}
Thanks for listening!!

Any Questions?

\begin{center}
\includegraphics[width=0.8\linewidth]{/home/ajensen123@ad.ufl.edu/figures/raster/first_banks_email.png}
\end{center}
\end{frame}
\section{References}
\label{sec:org316fb41}
\begin{frame}[label={sec:org37229af},fragile, allowframebreaks,  label=]{References}
\printbibliography
\end{frame}
\end{document}
