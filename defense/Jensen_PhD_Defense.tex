...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgbbf4083}]{Our Proposition}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf3b8ca4}]{Constraints}
\begin{columns}
...
\end{frame}
\section{Background}
\label{sec:org101d680}
\begin{frame}[label={sec:org810e1b3}]{Background - Projective Geometry}
\begin{center}
\includegraphics[width=0.8\textwidth]{/home/ajensen123@ad.ufl.edu/repo/lit-review/figures/raster/perspective-projection.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgf31facc}]{Background - Model-Image Registration}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org939cd1d}]{Background - Model-Image Registration}
\begin{columns}
\begin{column}{0.5\columnwidth}
If we know the projective parameters of the fluoroscopy machine, can we tinker with \(T^{cam}_{implant}\) so that our virtual projection matches the fluoroscopic image?
\end{column}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org675bb32}]{Historical Overview}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org12baf37}]{Pre-Computed Projections}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd4398e0}]{Limitations of Pre-Computed Projections}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf6d3f92}]{Motion Capture (MoCap)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8700503}]{Limitations of Motion Capture}
\begin{columns}
\begin{column}{0.5\columnwidth}
Skin Mounted
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org24a28f8}]{Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf40d6a9}]{Limitations of Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgfee4d0e}]{Iterative Projections}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8167cee}]{Limitations of (historic) Iterative Projection Methods}
\begin{columns}
\begin{column}{0.54\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org1369b49}]{Roentgen Stereophotogrammetry (RSA)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7f5a0d1}]{Limitations of RSA}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{frame}
\section{Aims}
\label{sec:org1eb19dc}
\begin{frame}[label={sec:org1391b7b}]{Aims}
...
\label{sec:org335a54d}
\begin{frame}[label={sec:orgb1ba159}]{Goal}
Demonstrate the feasibility of a fully autonomous, model-image registration pipeline.
\end{frame}
\begin{frame}[label={sec:org3c8c10d}]{Method}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org909c365}]{Autonomous Implant Detection Using Convolutional Neural Networks}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item 2 CNNs
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org969a766}]{Neural Network Data}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb863a2f}]{Neural Network Robustness}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org40e43dc}]{Normalized Fourier Descriptor Shape Libraries}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6846a6d}]{Pose Refinement Using Global Optimization}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3a4bb88}]{Contour-based Objective Function}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5307492}]{Improving Robustness}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5ef83f1}]{Optimization Routine}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf111184}]{Lipschitzian Optimization}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgeaf1d88}]{Lipschitzian Optimization without the Lipschitz Constant}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org59530d9}]{Trisecting Region}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5d128d8}]{Another Iteration}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
  \begin{bmatrix}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org34493d4}]{Determining Potentially Optimal Regions}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org1587104}]{DiRECT for Joint Track Machine Learning}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org5d3f4e5}]{Testing Performance}
Now that we have our refined poses, how well does out system perform?
\begin{center}
\includegraphics[width=\textwidth]{/home/ajensen123@ad.ufl.edu/repo/lit-review/figures/raster/jtml-pipeline.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org2911c67}]{Validation}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org1a89cbc}]{Awards}
...
\label{sec:org0a9c935}
\begin{frame}[label={sec:org439e27c}]{Goal}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgdff69be}]{Translation}
\begin{itemize}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org24212a5}]{Symmetry Traps}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org332f750}]{Solving the Symmetric Pose}
\begin{columns}
\begin{column}{0.55\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8f9ebaa}]{Methods - Training Set}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgea2a729}]{Methods - Machine Learning}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7ae5110},fragile]{Methods - Fixing ``Symmetry Traps''}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org3415efb}]{Results - ML Classification}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajensen123@ad.ufl.edu/figures/raster/sym-trap-ML-table.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org01b4771}]{Results - Fixing ``Symmetry Traps''}
\begin{itemize}
\item Accuracy: 91.9\%
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd2b7350}]{Results - Stratified \(\psi\) Correction Performance}
\begin{center}
\includegraphics[width=\textwidth]{/home/ajensen123@ad.ufl.edu/figures/raster/stratified-psi-ML-table.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd5d97ae}]{Discussion}
\begin{itemize}
...
\label{sec:org96436e4}
\subsection{Aim 4 - This will definitely work on shoulders, right?}
\label{sec:org6d7ff35}

\begin{frame}[label={sec:orgffbe4c8}]{Spoiler Alert}
\begin{columns}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org0b1d231}]{Methods - Shape Difference}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc6aadef}]{Methods - Shape Sensitivity}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org64905d8}]{Results - Humeral Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org653a28c}]{Results - Glenosphere Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgd7073b8}]{Results - Femoral Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org43bbaa4}]{Results - Tibial Shape Sensitivity}
\begin{figure}[h!]
	\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgbd20ed8}]{Key Takeaways}
\begin{itemize}
...
\end{frame}
\section{Conclusion}
\label{sec:org10507d5}
\begin{frame}[label={sec:orgf56f759}]{Conclusions}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org770abc0},fragile, allowframebreaks, label=]{Presentations}
\begin{refsection}
...
\end{refsection}
\end{frame}
\begin{frame}[label={sec:orge5a34ed},fragile, allowframebreaks, label=]{Publications}
\begin{refsection}
  \newrefcontext[sorting=ynt]
  \input{nocites-pubs}
