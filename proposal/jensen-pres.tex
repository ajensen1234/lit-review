...
\begin{frame}[label={sec:org8a73f6a}]{Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org92862ea}]{Limitations of Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgfc62565}]{Iterative Projections}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd69020f}]{Limitations of (historic) Iterative Projection Methods}
\begin{columns}
\begin{column}{0.54\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgb265dfe}]{Roentgen Stereophotogrammetry (RSA)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org758e517}]{Limitations of RSA}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\section{Aims}
\label{sec:org654b5fb}
\begin{frame}[label={sec:org4796920}]{Aims}
\begin{columns}
...
\label{sec:org6dadc38}
\begin{frame}[label={sec:orgddc7e42}]{Goal}
Demonstrate the feasibility of a fully autonomous, model-image registration pipeline.
\end{frame}
\begin{frame}[label={sec:orgc3342e0}]{Method}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgabb8dc4}]{Autonomous Implant Detection Using Convolutional Neural Networks}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item 2 CNNs
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge22a763}]{Neural Network Data}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga2b77b9}]{Neural Network Robustness}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0bdda94}]{Optimization Routine}
\begin{itemize}
...
\begin{frame}[label={sec:orga2f643a}]{Lipschitzian Optimization}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\label{sec:orgd413852}
\begin{frame}[label={sec:org2614c01}]{Goal}
...
\end{frame}
\begin{frame}[label={sec:org92296c3}]{Motivation}
\begin{itemize}
...
\begin{frame}[label={sec:org9d47d45}]{Method}
\begin{itemize}
...
\end{frame}
\section{References}
\label{sec:org3337640}
\begin{frame}[label={sec:orgd871118},fragile, allowframebreaks, label=]{References}
