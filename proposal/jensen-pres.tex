...
\label{sec:orgc4b7f7e}
\begin{frame}[label={sec:org8447ea2}]{Acknowledgments}
I would like to thank the McJunkin Family Charitable Foundation for their generous grant that supports this work.
\end{frame}
\section{Motivation}
\label{sec:org6e11516}
\begin{frame}[label={sec:orgb0e2696}]{The Problem}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3e2863e}]{Our Proposition}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org541e026}]{Constraints}
\begin{columns}
...
\end{frame}
\section{Background}
\label{sec:org20849fd}
\begin{frame}[label={sec:org9832a6b}]{Projective Geometry}
\begin{center}
\includegraphics[width=0.8\textwidth]{/home/andrew/repo/lit-review/figures/raster/perspective-projection.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org0e358f3}]{Model-Image Registration}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:org0e706ed}
\begin{frame}[label={sec:org932960c}]{Overview}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb7c0f47}]{Pre-Computed Projections}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org35be97a}]{Limitations of Pre-Computed Projections}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org471843e}]{Motion Capture (MoCap)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd0bfa82}]{Limitations of Motion Capture}
\begin{columns}
\begin{column}{0.5\columnwidth}
Skin Mounted
\begin{itemize}
...
\begin{frame}[label={sec:org9283a9b}]{Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7d99355}]{Limitations of Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org9804825}]{Iterative Projections}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6f04a08}]{Limitations of (historic) Iterative Projection Methods}
\begin{columns}
\begin{column}{0.54\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org3d35cbb}]{Roentgen Stereophotogrammetry (RSA)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org09ed61d}]{Limitations of RSA}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\section{Aims}
\label{sec:org1c00efe}
\begin{frame}[label={sec:org2871e0b}]{Aims}
\begin{columns}
...
\label{sec:org54ace3f}
\begin{frame}[label={sec:orgd7265db}]{Goal}
Demonstrate the feasibility of a fully autonomous, model-image registration pipeline.
\end{frame}
\begin{frame}[label={sec:org1484938}]{Method}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org055886e}]{Autonomous Implant Detection Using Convolutional Neural Networks}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item 2 CNNs
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd6312cf}]{Neural Network Data}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6a1a7e8}]{Neural Network Robustness}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org2f21687}]{Normalized Fourier Descriptor Shape Libraries}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7849896}]{Pose Refinement Using Global Optimization}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgd046b97}]{Contour-based Objective Function}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org590b43c}]{Improving Robustness}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org891d600}]{Optimization Routine}
\begin{itemize}
...
\begin{frame}[label={sec:orga4c3d6b}]{Lipschitzian Optimization}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgd8b4f45}]{Lipschitzian Optimization without the Lipschitz Constant}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orge77dc4d}]{Determining Potentially Optimal Regions}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org73f7e23}]{DiRECT for Joint Track Machine Learning}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org33fe861}]{Testing Performance}
Now that we have our refined poses, how well does out system perform?
\begin{center}
\includegraphics[width=\textwidth]{/home/andrew/repo/lit-review/figures/raster/pipeline-nocite.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc8d47fe}]{Validation}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4025ee0}]{Awards}
...
\label{sec:orgec65c00}
\begin{frame}[label={sec:org505e36d}]{Goal}
\begin{itemize}
...
\begin{frame}[label={sec:org7d3d336}]{Translation}
\begin{itemize}
...
\begin{frame}[label={sec:org4ffecd9}]{Symmetry Traps}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc9766e1}]{Solving the Symmetric Pose}
\begin{enumerate}
...
\begin{frame}[label={sec:orgb13fc63}]{Five Approaches}
\begin{itemize}
...
\begin{frame}[label={sec:orgedc4a53}]{Virtual Ligaments}
\begin{equation*}
...
\begin{frame}[label={sec:orgfcc0a3d}]{Binary Selection}
\begin{enumerate}
...
\end{frame}
\begin{frame}[label={sec:orgcd294a9}]{Bland-Altmann Calibration Constant}
\begin{itemize}
...
\begin{frame}[label={sec:orgedd68e8}]{Fully Connected Network}
\begin{itemize}
...
\begin{frame}[label={sec:org8bb2c5a}]{Timeline}
\begin{itemize}
...
\label{sec:org71a093a}
\begin{frame}[label={sec:org93a7692}]{Goal}
...
\begin{frame}[label={sec:org78dc200}]{Methods}
\begin{itemize}
\item 20-30 patients
...
\label{sec:orge3273a1}
\begin{frame}[label={sec:org59b0aa3}]{Goal}
...
\end{frame}
\begin{frame}[label={sec:orgfdfc2ae}]{Motivation}
\begin{itemize}
...
\begin{frame}[label={sec:orga478126}]{Method}
\begin{itemize}
...
\label{sec:org56ba0ca}
\begin{frame}[label={sec:org2d67d53}]{Goal}
...
\end{frame}
\section{References}
\label{sec:orgfe0cae4}
\begin{frame}[label={sec:orgf163a9d},fragile, allowframebreaks, label=]{References}
