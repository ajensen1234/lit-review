...
\label{sec:org1bd7392}
\begin{frame}[label={sec:org78e8f9d}]{Acknowledgments}
I would like to thank the McJunkin Family Charitable Foundation for their generous grant that supports this work.
\end{frame}
\section{Motivation}
\label{sec:org6c1ea48}
\begin{frame}[label={sec:org52d5eda}]{The Problem}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org189a99c}]{Our Proposition}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgfa2baab}]{Constraints}
\begin{columns}
...
\end{frame}
\section{Background}
\label{sec:org77da22b}
\begin{frame}[label={sec:org226dd98}]{Rigid Body Transformations}
...
\begin{frame}[label={sec:org8cb6512}]{Rigid Body Transformations}
...
\begin{frame}[label={sec:org872198f}]{Rigid Body Transformations}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb497994}]{Projective Geometry}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
  \begin{pmatrix}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga2deea1}]{Pixel Coordinates}
...
\begin{frame}[label={sec:org9e970d2}]{Model-Image Registration}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:org5324994}
\begin{frame}[label={sec:org1507682}]{Overview}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf2bc7aa}]{Pre-Computed Projections}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc48ae4a}]{Limitations of Pre-Computed Projections}
\begin{itemize}
...
\begin{frame}[label={sec:org2569383}]{Motion Capture (MoCap)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org731eff2}]{Limitations of Motion Capture}
Skin Mounted
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc503a29}]{Biplane Imaging}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7ca7de1}]{Limitations of Biplane Imaging}
\begin{itemize}
...
\begin{frame}[label={sec:orge45aed2}]{Iterative Projections}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0a791be}]{Limitations of (historic) Iterative Projection Methods}
\begin{itemize}
...
\begin{frame}[label={sec:orgf672b86}]{Model-based Roentgen Stereophotogrammetry (MBRSA)}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga93480c}]{Limitations of MBRSA}
\begin{itemize}
...
\section{Aims}
\label{sec:org713c743}
\begin{frame}[label={sec:org5c37035}]{Aims}
\begin{columns}
...
\section{References}
\label{sec:org00ca545}
\begin{frame}[label={sec:org817d7f7},fragile, allowframebreaks, label=]{References}
