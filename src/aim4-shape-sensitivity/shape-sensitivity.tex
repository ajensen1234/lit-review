...
In order to determine the ``shape sensitivity'' for a given input orientation, the central difference equation was applied to the shape descriptor for each of the three rotations
