...
\subsubsection{Invariant Angular Radial Transform}
...
I tried to emphasize this further in the above subsection by describing $>3$ rotations using a successive notation. I also tried to emphasize that this was for each $\delta_{x,y,z}$ in the equation itself.
}
\end{mdframed}
