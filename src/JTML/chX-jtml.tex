\chapter{JointTrack Machine Learning: An Autonomous Method of Measuring 6-DOF TKA Kinematics from Single-Plane Fluoroscopic Images}{\renewcommand*{\thefootnote}{\fnsymbol{footnote}}\footnotetext{Reprinted with permission from the Journal of Arthroplasty \cite{jensenJointTrackMachine2023}}
...
\begin{table}[ht]
	...
	\begin{threeparttable}
		\begin{tabularx}{\linewidth}{XXXXXXXXX}
			...
			\hline
			Standard & Inside AZ   & 187         & 0.69     & 0.52\tnote{b} & 1.75\tnote{a} & 0.73\tnote{a}        & 3.38             & 1.94\tnote{a}    \\ \\
			Standard & Outside AZ  & 83          & 0.69     & 0.47\tnote{c} & 0.917         & 1.03                 & 1.81             & 0.61             \\ \\
			Naive    & Inside AZ   & 47          & 0.80     & 0.74          & 1.72          & 1.39                 & 4.04             & 2.48\tnote{d}    \\ \\
