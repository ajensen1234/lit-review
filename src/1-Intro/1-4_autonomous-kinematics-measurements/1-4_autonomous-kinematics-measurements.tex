...
\input{src/1-Intro/1-4_autonomous-kinematics-measurements/implant-detection.tex}

\subsection{Initial Pose Estimation}
\label{sec:pose-estimation}
\input{src/1-Intro/1-4_autonomous-kinematics-measurements/pose-estimation.tex}

\subsection{Objective Function}
\label{sec:objective-function}
\input{src/1-Intro/1-4_autonomous-kinematics-measurements/objective-function.tex}

\subsection{Optimization Routine}
\label{sec:optimization-routine}
\input{src/1-Intro/1-4_autonomous-kinematics-measurements/optimization-routine.tex}
