...
\input{src/1-Intro/1-5_autonomous-kinematics-measurements/objective-function.tex}

\subsection{Optimization Routine}
\label{sec:optimization-routine}
\input{src/1-Intro/1-5_autonomous-kinematics-measurements/optimization-routine.tex}


\subsection{Overcoming Single-Plane Limitations}
\label{sec:single-plane-limitations}
\input{src/1-Intro/1-5_autonomous-kinematics-measurements/single-plane-limitations.tex}
