...
\begin{figure}
    \begin{center}
        \includegraphics[width = 0.85\linewidth]{figures/raster/shubert-step1.png}
        \vspace{3mm}
        \includegraphics[width = 0.85\linewidth]{figures/raster/shubert-step2.png}
        \vspace{3mm}
        \includegraphics[width = 0.85\linewidth]{figures/raster/shubert-step3.png}
    \end{center}
    \label{fig:shubert}
...
\begin{figure}[h!]
    ...
    \end{center}
    \caption{The DIviding RECTangles (DIRECT) algorithm in one dimension. It can find the global minimum of a funciton without a-priori knowledge of the Lipschitz constant.}
    \label{fig:direct-1D}
\end{figure}
