...
\input{src/1-Intro/1-2_computer-vision-primer/geometric-transformations.tex}

\subsection{Image Formation and Camera Properties}
\label{sec:img-form-camera-props}
\input{src/1-Intro/1-2_computer-vision-primer/image-formation-and-cameras.tex}

\subsection{Image Processing}
\label{sec:image-processing}
\input{src/1-Intro/1-2_computer-vision-primer/image-processing.tex}

\subsection{Image Similarity Metrics}
\label{sec:image-similarity}
\input{src/1-Intro/1-2_computer-vision-primer/image-similarity-metrics.tex}
...
\input{src/1-Intro/1-4_model-image-registration/1-4_model-image-registration.tex}

\section{Automating Measurements of Kinematics from Fluoroscopic Images}
\label{sec:autonomous-kinematics}
\input{src/1-Intro/1-5_autonomous-kinematics-measurements/1-5_autonomous-kinematics-measurements.tex}